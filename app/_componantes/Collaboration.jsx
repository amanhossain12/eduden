    ...
    <div>
      ...
      <section className="bg-black mt-20 sm:mt-32 text-white py-12 sm:py-16">
        <div className="max-w-7xl mx-auto w-full px-4 xl:px-0">
          {/* Collaboration Text */}
          <div className="text-left xl:text-center mb-10 sm:mb-12">
            ...
            <div className="inline-block group">
              <h2 className="text-3xl sm:text-4xl font-bold">
                ...
                <span className="text-yellow-400 relative">
                  Collaboration
                  <span className="block h-1 bg-yellow-400 w-20 mt-1 transition-all duration-300 group-hover:w-full rounded-full"></span>
                </span>
              </h2>
            </div>

            <p className="mt-4 sm:mt-6 text-sm sm:text-base text-gray-300 leading-relaxed max-w-3xl xl:mx-auto">
          ...
          <div className="w-full space-y-8">
            ...
            >
              <Image
                className="h-[25px] sm:h-[30px] mx-5"
                src="/group 150.png"
                alt="Fowzi Media"
                width={120}
                height={30}
              />
              <Image
                className="h-[22px] sm:h-[25px] mx-5"
                src="/layer-2.png"
                alt="Intellects.exe"
                width={110}
                height={30}
              />
              <Image
                className="h-[30px] sm:h-[40px] mx-5"
                src="/layer-1.png"
                alt="Randomuse"
                width={120}
                height={30}
