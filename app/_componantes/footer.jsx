  ...
  return (
    <footer className="bg-black text-white py-10 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-4">
            <Link href="#" aria-label="Facebook"><Facebook className="text-yellow-400 hover:text-white" /></Link>
            <Link href="#" aria-label="Instagram"><Instagram className="text-yellow-400 hover:text-white" /></Link>
            <Link href="#" aria-label="YouTube"><Youtube className="text-yellow-400 hover:text-white" /></Link>
            <Link href="#" aria-label="LinkedIn"><Linkedin className="text-yellow-400 hover:text-white" /></Link>
          </div>
        </div>
        ...
        {/* Learning Platform */}
        <div>
          <h4 className="font-semibold text-lg mb-4">Learning platform</h4>
          <ul className="space-y-2 text-sm text-gray-300">
      ...
      <div className="border-t border-gray-700 mt-10 pt-4 text-center text-sm text-gray-500">
        Copyright © 2024 Edu Den Powered by <span className="text-blue-400">Ethical Den</span>
      </div>
    </footer>
  );
};
